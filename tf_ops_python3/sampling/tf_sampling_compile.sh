...
# py3.6 + TF1.4.1
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /home/bolten/src/plsm/experimental/3D-BoNet/venv/lib/python3.6/site-packages/tensorflow/include -I /usr/local/cuda-8.0/include -I /home/bolten/src/plsm/experimental/3D-BoNet/venv/lib/python3.6/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-8.0/lib64/ -L/home/bolten/src/plsm/experimental/3D-BoNet/venv/lib/python3.6/site-packages/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
